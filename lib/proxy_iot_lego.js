...
exports.newInstance = async function($, spec) {
    try {
        ...
        /**
         * Get properties of the connected hub.
         *
         * See `types.js` for a description of `HubPropsType`.
         *
         * @return {HubPropsType|null} The connected hub properties or `null` if
         * not connected.
         *
         * @memberof!  module:caf_iot_lego/proxy_iot_lego#
         * @alias getHubProps
